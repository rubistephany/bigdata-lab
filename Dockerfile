...
# USER 1001: Cambia a usuario no-root por seguridad corporativa (menores privilegios).
# chown -R 1001: Asegura propiedad de la carpeta de trabajo para evitar errores de 'Permission Denied'.
...
# HEALTHCHECK: Permite a Kubernetes saber si el proceso interno responde en el puerto 4040. 
# Si el chequeo falla, el orquestador reinicia el contenedor de manera automática.
